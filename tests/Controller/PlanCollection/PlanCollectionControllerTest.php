...
class PlanCollectionControllerTest extends WebTestCase
{
    ...
    public function testNoTitle () {
        ...
        $form = $this->crawler->filter('.btn-primary')->form(array(
            'App_plancollection[title]' => '',
            'App_plancollection[plans]' => array($adminPlanId)
        ));
    ...
    public function testInvalidTitle () {
        ...
        $adminPlanId = $this->fixtures->getReference('admin-plan')->getId();
        $form = $this->crawler->filter('.btn-primary')->form(array(
            'App_plancollection[title]' => 'asdf asdf&%/&(/)',
            'App_plancollection[plans]' => array($adminPlanId)
        ));
    ...
    public function testEditPlanCollection()
    {
        ...
        $form = $this->crawler->filter('.btn-primary')->form(array(
            'App_plancollection[title]' => 'testcollection',
            'App_plancollection[plans]' => array(
    ...
    public function createACollection()
    {
        ...
        $this->assertNotEquals('admin plan template', $this->crawler->filter('#App_plancollection_plans')->text());
        $this->crawler = $this->client->submit($form);
        $this->assertEquals(302, $this->client->getResponse()->getStatusCode());
        $this->crawler = $this->client->followRedirect();
    }
