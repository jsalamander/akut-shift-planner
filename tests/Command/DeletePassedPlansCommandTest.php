...
class DeletePassedPlansCommandTest extends WebTestCase
{
    ...
    public function testExecute()
    {
        ...
        $collection = $em->getRepository("App:PlanCollection")->findOneById(
        ...
        $passedCollection = $em->getRepository("App:PlanCollection")->findOneById(
            $this->fixtures->getReference('admin-past-collection')->getId()
        );
        $this->assertNull($passedCollection);


        $passedShift = $em->getRepository("App:Shift")->findOneById(
